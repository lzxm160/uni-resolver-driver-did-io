...
//go:generate swagger generate server --target ../../uni-resolver-driver-did-io --name IoTexDriver --spec ../swagger.yml

func configureFlags(api *operations.IoTexDriverAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.IoTexDriverAPI) http.Handler {
